...
#### Хеш-индекс для поля to_user_id таблицы subscribe
Данный индекс необходим для поиска подписчиков для to_user_id, когда нужно быстро получить подписчиков для пользователя.
