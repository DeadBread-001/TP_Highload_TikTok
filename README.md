...
Суммарные затраты на сервера с собственным хостингом:
PostgreSQL: $250 * 500 = $125,000/мес.
ClickHouse: $330 * 500 = $165,000/мес.
Redis: $170 * 100 = $17,000/мес.
Kubenode: $330 * 600 = $198,000/мес.
Итог: $670,000/мес.

В случае с Amazon S3, плата взимается за Гб, которые мы храним. При стандартном тарифе плата будет составлять примерно
$23/ТБ * 4350 ТБ ≈ $100,050/мес.

Общая сумма при собственных серверах: $770,050/мес.
